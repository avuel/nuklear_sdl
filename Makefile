...
SHADERCROSS := $(or\
    $(shell command -v shadercross 2>/dev/null),\
    $(warning missing shadercross utility! shader recompilation will be impossible))
...
SRC := ./src/nuklear_sdl_renderer.c ./src/nuklear_sdl_renderer_config.c ./demo/main.c
